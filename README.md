...
* rename files from `IES2MaresJobs` to `example_me`
* change `IES2MaresJobs` to `example_me`
* change `IES2MARESJOBS_` to `EXAMPLE_ME_`
...
Note that previous versions of the Boilerplate did not include `IES2MaresJobs_Loader` but this class is used to register all filters and actions with WordPress.
